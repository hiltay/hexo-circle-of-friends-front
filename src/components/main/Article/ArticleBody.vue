...
let { current_sort_rule, Config, current_arcitle_num } = storeToRefs(MainStore);

let all_article_data = computed(() => MainStore.get_current_article_data)
let is_ended = computed(() => MainStore.article_is_ended)
